...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("OGN");
    case mBTC: return QString("mOGN");
    case uBTC: return QString::fromUtf8("μOGN");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("OGNCOINs"));
    case mBTC: return QString(QObject::tr("Milli-OGNCOINs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-OGNCOINs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
